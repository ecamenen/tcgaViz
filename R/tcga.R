...
#' }
#' @note
#' Subset of invasive breast carcinoma data from primary tumor tissue.
#' The cell type data are from a subset generated by the Cibersort_ABS
#' algorithm (\url{https://cibersort.stanford.edu/}).
