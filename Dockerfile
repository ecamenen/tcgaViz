...
ENV RPKGS attachment BiocManager config covr data.table devtools dplyr DT globals ggplot2 ggpubr golem knitr lintr markdown openxlsx pkgload plotly profviz readr reactlog reshape2 rmarkdown rsconnect rstatix shinytest spelling testthat shiny styler
